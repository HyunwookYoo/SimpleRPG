...
void ACollider::MoveForward(float Axis)
{
	if (OurMovementComponent)
	{
		OurMovementComponent->AddInputVector(GetActorForwardVector() * Axis);
	}
}

void ACollider::MoveRight(float Axis)
{
	if (OurMovementComponent)
	{
		OurMovementComponent->AddInputVector(GetActorRightVector() * Axis);
	}
}
